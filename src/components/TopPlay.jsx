    ...
    items-center">
      ...
      mx-3">
        <Link to={`/songs/${song.key}`}>
          <p className="text-xl font-bold text-white">{song?.
          title}</p>
        </Link>
        <Link to={`/artists/${song.artists[0].adamid}`}>
          <p className="text-base text-gray-300 mt-1">{song?.
          subtitle}</p>
        </Link>
      </div>
    </div>
...
const TopPlay = () => {
  ...
  return(
    ...
    mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
